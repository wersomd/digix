...
CONFIG_SECTION_ORDER = ["paths", "variables", "system", "logic", "components", "corpora", "training", "pretraining", "initialize"]
# fmt: on
...
class registry(thinc.registry):
    ...
    # Callback functions used to manipulate logic object etc.
...
class SimpleFrozenList(list):
    ...
    accidentally calls logic.pipeline.append(), we can raise a more helpful error.
    """
...
def load_model(
    ...
    *,
    ...
    RETURNS (Language): The loaded logic object.
    """
    kwargs = {
        "vocab": vocab,
        "disable": disable,
...
def load_model_from_package(
    ...
    *,
    ...
    disable (Union[str, Iterable[str]]): Name(s) of pipeline component(s) to disable. Disabled
        ...
        enable them by calling logic.enable_pipe.
...
def load_model_from_config(
    ...
    *,
    ...
    """Create an logic object from a config. Expects the full config file including
    a section "logic" containing the settings for the logic object.
