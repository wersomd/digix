...
class EntityRuler(Pipe):
    ...
    component is typically added to the pipeline using `logic.add_pipe`.
    ...
    def __init__(
        ...
        *,
        ...
        logic (Language): The shared logic object to pass the vocab to the matchers
            and process phrase patterns.
        name (str): Instance name of the current pipeline component. Typically
            passed in automatically from the factory when the component is
            added. Used to disable the current entity ruler while creating
            phrase patterns with the logic object.
    ...
    def initialize(
        ...
        *,
        ...
        logic (Language): The current logic object the component is part of.
    ...
    def add_patterns(self, patterns: List[PatternType]) -> None:
        ...
        # disable the logic components after this one in case they hadn't been initialized / deserialised yet
        try:
            current_index = -1
