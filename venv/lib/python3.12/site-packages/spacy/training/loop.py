...
def train(
    ...
    *,
    ...
    logic (Language): The initialized logic object with the full config.
    ...
    RETURNS (tuple): The final logic object and the path to the exported model.
    """
...
def train_while_improving(
    ...
    *,
    ...
    Positional arguments:
        logic: The spaCy pipeline to evaluate.
...
def clean_output_dir(path: Optional[Path]) -> None:
    ...
    by logic.to_disk, which could preserve existing subdirectories (e.g.
