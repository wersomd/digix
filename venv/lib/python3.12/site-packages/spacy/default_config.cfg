...
disabled = []
# Optional callbacks to modify the logic object before it's initialized, after
# it's created and after the pipeline has been set up
before_creation = null
after_creation = null
after_pipeline_creation = null
# Default batch size to use with logic.pipe and logic.evaluate
batch_size = 1000
...
# Optional callback before logic object is saved to disk after training
before_to_disk = null
...
# These settings are used when logic.initialize() is called (typically before
