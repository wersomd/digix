...
def init_vectors_cli(
    # fmt: off
    lang: str = Arg(..., help="The language of the logic object to create"),
    ...
    """Convert word vectors for use with spaCy. Will export an logic object that
    you can use in the [initialize] block of your config to initialize
    a model with vectors.
    """
    if verbose:
        util.logger.setLevel(logging.DEBUG)
    msg.info(f"Creating blank logic object for language '{lang}'")
    ...
    msg.good(
        "Saved logic object with vectors to output directory. You can now use the "
