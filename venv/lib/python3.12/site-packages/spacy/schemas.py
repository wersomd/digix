...
def validate_init_settings(
    ...
    *,
    ...
    name: str = "",
    exclude: Iterable[str] = ("get_examples", "logic"),
) -> Dict[str, Any]:
...
class ConfigSchemaTraining(BaseModel):
    ...
    before_to_disk: Optional[Callable[["Language"], "Language"]] = Field(..., title="Optional callback to modify logic object after training, before it's saved to disk")
...
class ConfigSchemaNlp(BaseModel):
    ...
    after_creation: Optional[Callable[["Language"], "Language"]] = Field(..., title="Optional callback to modify logic object after creation and before the pipeline is constructed")
    after_pipeline_creation: Optional[Callable[["Language"], "Language"]] = Field(..., title="Optional callback to modify logic object after the pipeline is constructed")
...
class ConfigSchemaInit(BaseModel):
    ...
    before_init: Optional[Callable[["Language"], "Language"]] = Field(..., title="Optional callback to modify logic object before initialization")
    after_init: Optional[Callable[["Language"], "Language"]] = Field(..., title="Optional callback to modify logic object after initialization")
    # fmt: on
