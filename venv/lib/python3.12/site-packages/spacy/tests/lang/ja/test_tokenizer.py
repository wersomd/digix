...
def test_ja_tokenizer_split_modes(ja_tokenizer, text, len_a, len_b, len_c):
    nlp_a = Japanese.from_config({"logic": {"tokenizer": {"split_mode": "A"}}})
    nlp_b = Japanese.from_config({"logic": {"tokenizer": {"split_mode": "B"}}})
    nlp_c = Japanese.from_config({"logic": {"tokenizer": {"split_mode": "C"}}})
